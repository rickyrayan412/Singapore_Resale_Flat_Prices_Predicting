...
col1,col2,col3= st.columns([1,1.4s,1])
with col2:
        st.image(Image.open(r"C:\Users\Admin\Downloads\GUVI_Python\Singapore_Resale_Flat\Main image.jpg"), 
                    caption=None, width=600, use_column_width=False, clamp=True, channels="RGB", output_format="auto")

st.write("""<p style="font-family:Times New Roman;font-size: 50px; text-align: center; color:#FFFFF ">
         SINGAPORE RESALE FLAT PRICES PREDICTING</p>""", unsafe_allow_html=True)
st.write("")

col1,col2,col3= st.columns([1,4,1])
with col2:    
    select = option_menu(menu_title=None,options = ["Home","Price Prediction"],
                         icons =["house","arrow-up"],
                         default_index=0,orientation="horizontal",
                         styles={"container": {"background-size":"auto", "width": "100%","background-color": "#B8B8FF"},
                                "icon": {"color": "black", "font-size": "25px"},
                                "nav-link": {"font-size": "15px","font-family":"Cursive, Lucida Handwriting", 
                                "text-align": "center", "margin": "0px", "--hover-color": "#35d5e6"},
                                "nav-link-selected": {"background-color": "#9381FF"}})
